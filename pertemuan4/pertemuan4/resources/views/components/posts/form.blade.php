...
<form action="{{ route('dashboard.store') }}" method="POST">
    ...
    <div class="grid gap-4 grid-cols-2">
        ...
        <div class="col-span-2">
            ...
            <input type="text" name="title" id="title" value="{{ old('title') }}" class="block w-full px-3 py-2.5 bg-neutral-secondary-medium border border-default-medium text-heading text-sm rounded-base focus:ring-brand focus:border-brand shadow-xs placeholder:text-body" placeholder="Enter post title">
        </div>
